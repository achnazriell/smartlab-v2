    ...
    <section class="gradient-hero text-white relative overflow-hidden pt-20 pb-20 lg:pt-32 lg:pb-32">
        ...
        <div class="container mx-auto px-4 lg:px-6 relative z-10">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div
                    class="inline-flex items-center space-x-3 bg-white/10 backdrop-blur-sm rounded-full px-6 lg:px-8 py-3 lg:py-4 mt-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                ...
                <div>
                    ...
                    <form id="contactForm" class="space-y-6" @submit.prevent="submitted = true">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="name"
                                    class="block text-gray-700 font-semibold mb-3 text-sm lg:text-base">Nama
                                    Lengkap</label>
                            ...
                            <div>
                                <label for="email"
                                    class="block text-gray-700 font-semibold mb-3 text-sm lg:text-base">Email</label>
                        ...
                        <div>
                            <label for="subject"
                                class="block text-gray-700 font-semibold mb-3 text-sm lg:text-base">Subjek</label>
                        ...
                        <div>
                            <label for="category"
                                class="block text-gray-700 font-semibold mb-3 text-sm lg:text-base">Kategori</label>
                        ...
                        <div>
                            <label for="message"
                                class="block text-gray-700 font-semibold mb-3 text-sm lg:text-base">Pesan</label>
                            <textarea id="message" name="message" rows="5" required class="form-input text-sm lg:text-base"
                ...
                <div>
                    ...
                    <div class="mb-12">
                        ...
                        <div
                            class="w-full h-72 lg:h-80 bg-gradient-to-br from-sky-100 to-blue-100 flex items-center justify-center rounded-2xl shadow-sm overflow-hidden">
                            <div class="text-center p-8">
                                <svg class="w-16 h-16 lg:w-20 lg:h-20 text-blue-600 mx-auto mb-4 float-animation"
                                ...
                                <h3 class="text-xl lg:text-2xl font-bold text-gray-900 mb-2">Smart-LAB Headquarters
                                </h3>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                            <a href="#"
                                class="contact-card bg-white p-5 lg:p-6 text-center hover:bg-sky-50 transition-colors border-t-4 border-sky-400 shadow-sm">
                                <div
                                    class="w-12 h-12 bg-sky-50 rounded-full flex items-center justify-center mx-auto mb-4">
                            ...
                            <a href="#"
                                class="contact-card bg-white p-5 lg:p-6 text-center hover:bg-pink-50 transition-colors border-t-4 border-pink-400 shadow-sm">
                                <div
                                    class="w-12 h-12 bg-pink-50 rounded-full flex items-center justify-center mx-auto mb-4">
                            ...
                            <a href="#"
                                class="contact-card bg-white p-5 lg:p-6 text-center hover:bg-red-50 transition-colors border-t-4 border-red-400 shadow-sm">
                                <div
                ...
                <div class="space-y-4 lg:space-y-6">
                    <div class="contact-card bg-white p-6 lg:p-8 border-l-4 border-sky-400 shadow-sm">
                        ...
                        <p class="text-gray-600 text-sm lg:text-base leading-relaxed">
                            Klik tombol "Masuk" di pojok kanan atas, lalu pilih "Daftar". Isi formulir pendaftaran
                            dengan data yang valid, dan Anda akan mendapatkan akses langsung ke platform.
                        </p>
                    </div>
                    ...
                    <div class="contact-card bg-white p-6 lg:p-8 border-l-4 border-sky-400 shadow-sm">
                        ...
                        <p class="text-gray-600 text-sm lg:text-base leading-relaxed">
                            Ya, Smart-LAB sepenuhnya gratis untuk semua pengguna. Kami percaya pendidikan berkualitas
                            harus dapat diakses oleh semua orang tanpa hambatan biaya.
                        </p>
                    </div>
                    ...
                    <div class="contact-card bg-white p-6 lg:p-8 border-l-4 border-sky-400 shadow-sm">
                        ...
                        <p class="text-gray-600 text-sm lg:text-base leading-relaxed">
                            Hubungi tim support kami melalui email support@smartlab.com atau chat langsung di WhatsApp.
                    ...
                    <div class="contact-card bg-white p-6 lg:p-8 border-l-4 border-sky-400 shadow-sm">
                        ...
                        <p class="text-gray-600 text-sm lg:text-base leading-relaxed">
                            Smart-LAB sepenuhnya responsif dan dapat diakses melalui browser mobile. Aplikasi native
                            sedang dalam pengembangan dan akan segera hadir di App Store dan Play Store.
                        </p>
                    </div>
                </div>
            </div>
