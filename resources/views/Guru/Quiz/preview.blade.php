    ...
    <div class="space-y-6 mb-8">
        ...
        <div class="preview-card bg-white rounded-xl shadow-sm p-6">
            <div class="flex items-start justify-between mb-4">
                <div>
                    <div class="flex items-center space-x-3 mb-2">
                        ...
                        <span class="{{ $question->type === 'PG' ? 'bg-blue-50 text-blue-800 border-2 border-blue-200' : 'bg-blue-100 text-blue-800' }} text-sm font-medium px-3 py-1 rounded-full">
                            {{ $question->type === 'PG' ? 'Pilihan Ganda' : 'Isian Singkat' }}
                        </span>
                        <span class="bg-yellow-50 text-yellow-800 border-2 border-yellow-200 text-sm font-medium px-3 py-1 rounded-full">
                            {{ $question->score }} Poin
                        </span>
                    </div>
            ...
            <div class="space-y-3 mt-4">
                ...
                <div class="flex items-center space-x-3 p-3 {{ $choice->is_correct ? 'bg-blue-50 border-blue-300' : 'bg-gray-50 border-gray-200' }} border-2 rounded-lg">
                    <div class="{{ $choice->is_correct ? 'badge-blue' : 'bg-gray-100 text-gray-800' }} w-8 h-8 flex items-center justify-center rounded-full font-bold">
                        {{ chr(65 + $loop->index) }}
                    </div>
                    <span class="{{ $choice->is_correct ? 'text-blue-800 font-medium' : 'text-gray-700' }} flex-1">
                        {{ $choice->text }}
                    </span>
            ...
            <div class="mt-4">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <span class="bg-blue-100 text-blue-800 border-2 border-blue-200 text-sm px-3 py-1.5 rounded-full">
                        {{ $answer }}
                    </span>
                    @endforeach
                </div>
        ...
        <div class="flex justify-between items-center">
            <div>
                <p class="text-gray-600">Status Quiz:
                    <span class="font-medium {{ $quiz->status === 'draft' ? 'text-yellow-600' : ($quiz->status === 'active' ? 'text-green-600' : 'text-red-600') }}">
        ...
        <div class="custom-modal-header">
            <div class="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Quiz akan dapat diakses oleh siswa setelah dipublikasikan.</p>
                </div>
            </div>
        </div>
