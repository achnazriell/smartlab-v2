...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-blue-400 rounded-2xl p-8 text-white shadow-lg">
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    <h1 class="text-3xl md:text-4xl font-bold text-white">Hasil Quiz</h1>
                    <p class="text-blue-50 mt-2">{{ $quiz->title }}</p>
                </div>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        ...
                        <p class="text-xs md:text-sm text-gray-600 mt-1">Total: <span
                                class="font-semibold text-blue-600">{{ $attempts->total() }}</span> percobaan</p>
                    </div>
                </div>
            </div>
