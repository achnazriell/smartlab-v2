    ...
    @section('content')
            ...
            <div
                ...
                <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    ...
                    <div class="hidden md:block">
                        <img src="https://pkl.hummatech.com/assets-user/dist/images/breadcrumb/ChatBc.png"
                            alt="Illustration"
                ...
                <div class="px-6 py-4 border-b border-slate-200 bg-slate-50">
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <div class="flex space-x-2">
                            @if (request('search_class') || request('grade') || request('sort') || request('per_page') != 10)
                            ...
                            <!-- Search form -->
                            <form id="searchForm" action="{{ route('classes.index') }}" method="GET"
                                class="flex items-center">
                                <div class="relative flex items-center">
                                    <input type="text" name="search_class" id="searchInput"
                                        placeholder="Cari kelas..." value="{{ request('search_class') }}"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div
                                                ...
                                                <span
                                                    class="font-bold text-blue-600">{{ substr($class->name_class, 0, 1) }}</span>
                                            </div>
                                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <select name="name_class[0]" required
                                            ...
                                            <option value="X" {{ old('name_class.0') == 'X' ? 'selected' : '' }}>X
                                            </option>
                                            <option value="XI" {{ old('name_class.0') == 'XI' ? 'selected' : '' }}>XI
                                            </option>
                                            <option value="XII" {{ old('name_class.0') == 'XII' ? 'selected' : '' }}>
                                                XII
                                            </option>
                                        </select>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-slate-700 mb-1">Nama Kelas <span
                                                class="text-red-500">*</span></label>
                                        <input type="text" name="name_class[1]" required
                                            placeholder="Contoh: RPL 1, IPA 2"
                                            class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
                                            value="{{ old('name_class.1') }}">
                                    </div>
                                </div>
        ...
        <div id="editModal" class="fixed inset-0 z-50 hidden" role="dialog" aria-modal="true">
            <!-- Similar structure to add modal, will be populated by JavaScript -->
        </div>

        {{-- Delete Modal --}}
        <div id="deleteModal" class="fixed inset-0 z-50 hidden" role="dialog" aria-modal="true">
            <!-- Similar structure, will be populated by JavaScript -->
        </div>
                                                ...
                                                <div class="p-6 space-y-4">
                                                    <div class="grid grid-cols-2 gap-4">
                                                        <div>
                                                            ...
                                                            <select name="name_class[0]" required class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200">
                                                                <option value="">Pilih Angkatan</option>
                                                                <option value="X" ${data.data.angkatan == 'X' ? 'selected' : ''}>X</option>
                                                                <option value="XI" ${data.data.angkatan == 'XI' ? 'selected' : ''}>XI</option>
                                                                <option value="XII" ${data.data.angkatan == 'XII' ? 'selected' : ''}>XII</option>
                                                            </select>
                                                        </div>
                                                        <div>
                                                            <label class="block text-sm font-medium text-slate-700 mb-1">Nama Kelas <span class="text-red-500">*</span></label>
                                                            <input type="text" name="name_class[1]" required placeholder="Contoh: RPL 1, IPA 2"
                                                                class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
                                                                value="${data.data.nama_kelas}">
                                                        </div>
                                                    </div>
