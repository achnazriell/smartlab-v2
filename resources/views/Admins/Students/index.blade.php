            ...
            @if (session('import_stats'))
                ...
                <div class="mb-6 animate-fade-in">
                    <div class="space-y-4">
                        ...
                        {{-- Header Ringkasan --}}
                        <div
                            class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-4 border border-blue-200 shadow-sm">
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-slate-600 mt-1">Total <span
                                                class="font-semibold">{{ $stats['total_processed'] }}</span> data diproses
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-wrap gap-2">
                                ...
                                @if ($stats['skipped'] > 0)
                                    <span
                                        class="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium bg-slate-100 text-slate-700">
                                        <svg class="w-4 h-4 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd"
                            ...
                            <div class="border border-green-200 rounded-xl overflow-hidden bg-white shadow-sm">
                                <div
                                    ...
                                    <h4 class="font-semibold text-green-800 flex items-center">
                                        ...
                                        <span
                                            class="ml-2 bg-green-200 text-green-800 px-2.5 py-0.5 rounded-full text-xs font-medium">{{ $stats['imported'] }}
                                            murid</span>
                                    </h4>
                                </div>
                                            ...
                                            @foreach (array_slice($stats['success_data'], 0, 50) as $index => $item)
                                                <tr class="hover:bg-green-50 transition-colors duration-150">
                                                    ...
                                                    <td
                                                        ...
                                                        {{ $item['nis'] }}</td>
                                                    <td
                                                        class="px-4 py-3 whitespace-nowrap text-sm text-blue-600 font-medium">
                                                        {{ $item['kelas'] ?? '-' }}
                                                    </td>
                                                </tr>
                                            @endforeach
                            ...
                            <div class="border border-amber-200 rounded-xl overflow-hidden bg-white shadow-sm">
                                <div
                                    ...
                                    <h4 class="font-semibold text-amber-800 flex items-center">
                                        ...
                                        Data Duplikat
                                        <span
                                            class="ml-2 bg-amber-200 text-amber-800 px-2.5 py-0.5 rounded-full text-xs font-medium">{{ $stats['duplicate'] }}
                                            data</span>
                                    </h4>
                                </div>
                                <div class="max-h-80 overflow-y-auto">
                                    ...
                                    @if (count($stats['duplicate_data']) > 30)
                                        <div
                                            ...
                                            <p class="text-sm text-gray-600 text-center flex items-center justify-center">
                                                ...
                                                dan <strong
                                                    class="mx-1">{{ count($stats['duplicate_data']) - 30 }}</strong>
                                                data duplikat lainnya
                                            </p>
                                        </div>
                                    @endif
                                </div>
                            ...
                            <div class="border border-blue-200 rounded-xl overflow-hidden bg-white shadow-sm">
                                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-4 py-3 border-b border-blue-200">
                                    <h4 class="font-semibold text-blue-800 flex items-center">
                                        ...
                                        Kelas Dibuat Otomatis
                                        <span
                                            class="ml-2 bg-blue-200 text-blue-800 px-2.5 py-0.5 rounded-full text-xs font-medium">{{ count($stats['created_classes']) }}
                                            kelas</span>
                                    </h4>
                                </div>
                                <div class="p-4">
                                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                                        @foreach ($stats['created_classes'] as $className => $count)
                                            <div
                                                class="flex justify-between items-center bg-gradient-to-r from-blue-50 to-indigo-50 p-3 rounded-lg border border-blue-200 hover:shadow-md transition-shadow duration-200">
                                                <span class="font-semibold text-slate-700">{{ $className }}</span>
                                                <span
                                                    class="bg-blue-500 text-white px-3 py-1 rounded-full text-xs font-bold">{{ $count }}
                                                    siswa</span>
                                            </div>
                                        @endforeach
                                    </div>
                            ...
                            <div class="border border-red-200 rounded-xl overflow-hidden bg-white shadow-sm">
                                <div class="bg-gradient-to-r from-red-50 to-pink-50 px-4 py-3 border-b border-red-200">
                                    <h4 class="font-semibold text-red-800 flex items-center">
                                        ...
                                        Kesalahan Validasi
                                        <span
                                            class="ml-2 bg-red-200 text-red-800 px-2.5 py-0.5 rounded-full text-xs font-medium">{{ count($stats['errors']) }}
                                            error</span>
                                    </h4>
                                </div>
                                    ...
                                    @if (count($stats['errors']) > 15)
                                        <div
                                            ...
                                            <p class="text-sm text-gray-600 text-center flex items-center justify-center">
                                                ...
                                                dan <strong class="mx-1">{{ count($stats['errors']) - 15 }}</strong>
                                                error lainnya
                                            </p>
                                        </div>
                                    @endif
