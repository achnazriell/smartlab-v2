    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-xl font-semibold text-gray-800">Detail Feedback</h2>
                    <p class="text-sm text-gray-500">ID: #{{ str_pad($feedback->id, 6, '0', STR_PAD_LEFT) }}</p>
                </div>
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    <h4 class="font-medium text-gray-700 mb-2">Pesan Feedback</h4>
                ...
                <!-- Meta Info -->
                <div>
                    <h4 class="font-medium text-gray-700 mb-2">Informasi</h4>
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium">
                                <form action="{{ route('admin.feedback.update-status', $feedback) }}" method="POST" class="inline">
                                    @csrf
                                    @method('PUT')
                                    <select name="status"
