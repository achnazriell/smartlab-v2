...
@section('content')
    ...
    <div class="p-4 sm:p-6 lg:p-8">
        ...
        <div class="banner-wrap mb-6">
            <img src="{{ asset('image/banner_ mapel.webp') }}" alt="banner soal">
        ...
        @if (request('search') || request('status'))
            <div class="mb-4 flex items-center gap-2 text-sm text-gray-500">
                ...
                @if (request('status'))
                    ...
                    <span
                        class="bg-yellow-100 text-yellow-700 px-2 py-0.5 rounded-lg">{{ $labels[request('status')] ?? request('status') }}</span>
                @endif
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                @forelse($exams as $exam)
                    @php
                        ...
                        $attempt = $exam->user_attempt ?? null;
                        ...
                        if ($attempt && $attempt->status === 'in_progress') {
                            ...
                            $buttonLink = route('soal.attempt', $exam->id);
                            ...
                            $buttonLink = route('soal.result', $attempt->id);
                    ...
                    <div class="card-soal bg-white shadow-md">
                        ...
                        <div class="relative h-44 flex flex-col justify-between text-white p-5"
                            ...
                            <div
                                class="relative z-10 flex items-center justify-between text-sm text-white/90 border-t border-white/25 pt-3">
                    ...
                    <div class="col-span-full py-16 text-center">
                        <div class="inline-flex items-center justify-center w-20 h-20 bg-blue-100 rounded-full mb-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" class="text-blue-400">
